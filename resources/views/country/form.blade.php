<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            <label for="code" class="form-label">{{ __('Code') }} ISO 3166-1</label>
            <input type="text" name="code" class="form-control @error('code') is-invalid @enderror" value="{{ old('code', $country?->code) }}" id="code" placeholder="Code">
